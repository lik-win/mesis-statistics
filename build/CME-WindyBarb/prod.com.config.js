...
export default defineConfig({
  ...
  // 打包配置
  build: {
    input: "../../src/components/cme-application/WindyBarb/index.js", // 只打包 引入及其依赖
    outDir: "dist/CME-WindyBarb", //输出文件名称
    ...
    lib: {
      entry: path.resolve(
        __dirname,
        "../../src/components/cme-application/WindyBarb/index.js"
      ), //指定组件编译入口文件
      name: "CME-WindyBarb",
      fileName: "CME-WindyBarb",
    }, //库编译模式配置
    rollupOptions: {
      // 确保外部化处理那些你不想打包进库的依赖
      external: [
